                        ...
                        <>
                            <div className="dealers-form-row">
                                <div className="expenses-field">
                                    ...
                                    <input id="g-weight" type="number" step="0.001" min="0" value={form.weight} onChange={e => up('weight', e.target.value)} placeholder="e.g. 6.000" autoFocus />
                                </div>
                                <div className="expenses-field">
                                    <label htmlFor="g-purity"><Percent size={14} /> Purity (%)</label>
                                    <input id="g-purity" type="number" step="0.01" min="0" max="100" value={form.purity} onChange={e => up('purity', e.target.value)} placeholder="e.g. 99.90" />
                                </div>
                            </div>
                            {w > 0 && (
                        ...
                        <>
                            <div className="dealers-form-row">
                                <div className="expenses-field">
                                    ...
                                    <input id="a-amount" type="number" step="1" min="0" value={form.amount} onChange={e => up('amount', e.target.value)} placeholder="e.g. 5000" autoFocus />
                                </div>
                                <div className="expenses-field">
                                    <label htmlFor="a-rate"><IndianRupee size={14} /> Rate (₹/g)</label>
                                    <input id="a-rate" type="number" step="0.01" min="0" value={form.rate} onChange={e => up('rate', e.target.value)} placeholder="e.g. 13040" />
                                </div>
                            </div>
                            {amt > 0 && rt > 0 && (
                                <div className="dealers-pure-calc">
